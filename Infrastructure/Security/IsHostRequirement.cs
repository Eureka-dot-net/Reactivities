...
namespace Infrastructure.Security
{
    ...
    public class IsHostHandler(AppDbContext dbContext, IHttpContextAccessor httpContextAccessor) 
        : AuthorizationHandler<IsHostRequirement>
    {
        protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context, IsHostRequirement requirement)
        {
            ...
            {
                context.Fail(new AuthorizationFailureReason(this, "User is not the host of the activity."));
            }
        }
    }
}
